...
class Focus(nn.Module):
    ...
    # def __init__(self, in_channels, out_channels, ksize=1, stride=1, act="prelu"):
        super().__init__()
...
class BaseConv(nn.Module):
    def __init__(self, in_channels, out_channels, ksize, stride, groups=1, bias=False, act="frelu"):
...
class DWConv(nn.Module):
    def __init__(self, in_channels, out_channels, ksize, stride=1, act="frelu"):
