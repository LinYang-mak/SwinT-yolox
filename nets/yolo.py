...
import math
from .darknet import BaseConv, CSPDarknet, CSPLayer, DWConv, CBAM,SE
from .model import swin_base_patch4_window7_224
from .model import swin_tiny_patch4_window7_224,swin_base_patch4_window12_384,swin_large_patch4_window7_224_in22k,swin_large_patch4_window12_384_in22k,swin_small_patch4_window7_224
class YOLOXHead(nn.Module):
    def __init__(self, num_classes, width=1.0, in_channels=[256, 512, 1024],
                 act="frelu", depthwise=False, ):
    # def __init__(self, num_classes, width=1.0, in_channels=[256, 512, 1024],
...
class YOLOPAFPN(nn.Module):
    def __init__(self, depth=1.0, width=1.0,
                 ...
                 in_channels=[256, 512, 1024], depthwise=False, act="frelu"):
    # def __init__(self, depth = 1.0, width = 1.0,
    #              in_features = ("dark3", "dark4", "dark5"),
    #              in_channels = [256, 512, 1024], depthwise = False, act = "silu"):
        ...
        # self.se1 = SE(c1=int(in_channels[1] * width))
        # self.se2 = SE(c1=int(in_channels[0] * width))
        # self.se3 = SE(c1=int(in_channels[0] * width))
        # self.se4 = SE(c1=int(in_channels[1] * width))
        #-------------------------------------------#
    ...
    def forward(self, input):
        ...
        # P5_upsample = self.se1(P5_upsample)
        ...
        # P4_upsample = self.se2(P4_upsample)
        #-------------------------------------------#
        ...
        # P3_downsample = self.se3(P3_downsample)
        #-------------------------------------------#
        ...
        # P4_downsample = self.se4(P4_downsample)
        #-------------------------------------------#
